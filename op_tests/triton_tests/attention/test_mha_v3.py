...
# ===========================================================================
# Additional mha_v3 tests: FP8 fwd/bwd, paged CUDA graph capture, and
# flash_attn_func / flash_attn_varlen_func CUDA graph capture.
# ===========================================================================
...
def test_flash_attn_kvcache_paged_cudagraph(mha_type):
    """CUDA graph capture with paged KV cache (block_table)."""
    d = 128
    device = "cuda"
    torch.random.manual_seed(SEED)
    torch.cuda.manual_seed(SEED)
